...
`~15 ms` GPU inference · `84` instruments traded · `20+` agents in production · <!-- BEGIN:commits -->4.9k<!-- END:commits --> commits/year
...
> **98.2% of my commits and pull requests land in private repositories** —
> 4,705 against 87 public, across 29 closed repos. The code stays closed, the volume does not.
<!-- END:stats -->
...
<!-- BEGIN:footer -->
<sub>Regenerated Aug 13, 2026, 3:52 a.m. · Santiago, Chile · every panel on this page is produced by a workflow in this repository</sub>
<!-- END:footer -->
